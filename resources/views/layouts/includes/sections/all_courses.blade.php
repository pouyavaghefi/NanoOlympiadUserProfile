@php
    ...
    if($course->intro_video){
     ...
     $episode = $course->episodes->where('show_status', 1)->first();
     $thumbPath = $episode?->thumb_path;
     $imageUrl = $thumbPath ? admin_asset($thumbPath) : 'https://via.placeholder.com/300x200?text=No+Image';
@endphp
    ...
    <div class="card">
        ...
        <div class="lesson_name">
            <div class="bg-primary d-flex justify-content-center align-items-center flex-column position-relative img-overlay">
                <img src="{{ $imageUrl }}" alt="course-img" class="img-fluid">
